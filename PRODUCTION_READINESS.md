...
Проект **не является Production Ready**. D6, D3, D4, D2, D5, D7, D8, D11 и D12 закрыты
...
Открытых P0/P1 нет; G6, G7 и G16 пройдены. Открытых P2 — 4; остальные defects и release gates
остаются открытыми.
